...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-primary-foreground px-4 py-16">
      ...
      <div className="mb-8">
        <h1 className="text-[180px] font-bold leading-none text-foreground sm:text-[240px] lg:text-[300px]">
          404
        </h1>
      </div>
      ...
      <div className="mb-8 max-w-2xl rounded-3xl bg-primary px-8 py-12 text-center sm:px-12">
        ...
        >
          <Link href="/" className="flex items-center gap-2">
            GO BACK HOME
            <div className="flex size-8 items-center justify-center rounded-full bg-primary-foreground transition-all duration-300 group-hover:rotate-[-45deg] group-hover:bg-foreground">
              <ArrowRight className="size-4 text-black transition-colors duration-300 group-hover:text-white" />
            </div>
          </Link>
        </Button>
      </div>

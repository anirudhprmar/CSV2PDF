              ...
              <div className="space-y-8 text-gray-700 dark:text-gray-300">
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    <p className="leading-relaxed">
                      To access the premium features of the Service, you must register for an account. 
                      When you register, you agree to:
                    </p>
                    <ul className="list-disc list-inside space-y-1 ml-4">
                      <li>Provide accurate, current, and complete information (via Google Sign-In)</li>
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-4">
                      <li>
                        <strong>Lifetime Access:</strong> This one-time fee grants you permanent access to all current and future premium features of the software without any recurring subscription fees.
                      </li>
                      <li>
                        <strong>No Hidden Fees:</strong> There are no monthly charges or hidden costs.
                      </li>
                      <li>
                        <strong>Refund Policy:</strong> Due to the digital nature of the product and its low cost, all sales are final. However, if you experience technical issues that prevent you from using the software, please contact support for assistance.
                      </li>
                    </ul>
                  </div>
                </section>
